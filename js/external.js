...
//
//let roominclass = confirm('Does the class have room for you?')
//
//alert('it is' + (roominclass + timeinschedule) + "You can attend this class")


  //r cf = confirm('Is class full?')
  //  console.log(cf)
  //(confirm) true
  //  alert('Not enrolled')
  //  console.log(confirm);
  //(confirm) false
  //  var sc = confirm('Is there a schedule conflict?')
  //      console.log(sc)
  //  if(sc) true
  //      alert('Not enrolled')
  //  if(confirm) false
